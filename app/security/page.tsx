...
const controls = [
  ...
  { icon: <ShieldCheck />, title: "TRON multisig treasury", text: "The treasury uses TRON Account Permission Management with a threshold greater than one. A single operator cannot control it." },

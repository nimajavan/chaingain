      ...
      <div className="min-h-screen">
        ...
        <footer className="mt-24 border-t border-white/[.07] bg-black/10">
          <div className="mx-auto grid max-w-7xl gap-10 px-4 py-12 sm:px-6 md:grid-cols-[1.4fr_1fr_1fr_1fr] lg:px-8">
            <div><div className="flex items-center gap-2.5"><span className="primary-gradient flex h-8 w-8 items-center justify-center rounded-lg"><Ticket className="h-4 w-4" /></span><span className="display-font font-bold text-white">LottoChain</span></div><p className="mt-4 max-w-xs text-sm leading-6 text-zinc-500">Transparent draws. Verifiable randomness. Non-custodial USDT payouts.</p><p className="mt-5 text-xs text-zinc-600">TRON Mainnet · USDT (TRC-20) · 18+ only</p></div>

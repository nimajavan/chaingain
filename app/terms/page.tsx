// Plain-language preview terms, eligibility, and responsible-play information.
export default function TermsPage() {
  return (
    <main className="mx-auto max-w-4xl px-4 pb-8 pt-12 sm:px-6 lg:px-8">
      <p className="text-sm font-semibold uppercase tracking-[.2em] text-violet-400">Preview legal framework</p>
      ...
      <div className="mt-10 space-y-4">
        <TermSection title="1. Testnet preview"><p>LottoChain is currently presented as an interactive Polygon Amoy preview. Demo balances, draw records, transaction hashes, and prizes are illustrative; no real-value wagering is enabled through this deployment.</p></TermSection>
        ...
        <TermSection title="4. Draw mechanics"><p>Each ticket costs 10 USDC. Chainlink VRF selects the winning ticket after the scheduled deadline. The contract allocates 70% of the pool to the winner and 30% to the treasury. These values are intended to be hard-coded and publicly verifiable.</p></TermSection>

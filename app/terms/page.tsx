  ...
  return (
    <main className="mx-auto max-w-4xl px-4 pb-8 pt-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-10 space-y-4">
        <TermSection title="1. Launch status"><p>LottoChain remains pre-production. Real-value ticket sales stay locked until the independently audited contracts, treasury permissions, oracle funding, and jurisdictional approval are in place. The application displays only confirmed indexed chain data.</p></TermSection>
